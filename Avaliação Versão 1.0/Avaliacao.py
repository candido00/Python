...
frameResultado.grid(row=6,column=0,columnspan=4)
...
#========================Botoes=========================================
btED = tk.Button(frameSelect, text="Cadastrar",width="30",command=Janela.OpenCadastrar)
btED.grid(row=1,column=0,columnspan=2)

btEX = tk.Button(frameSelect,text="Excluir",width="29",command=Janela.OpenExcluir)
btEX.grid(row=1,column=2,columnspan=2) 

btIN = tk.Button(frameSelect,text="Editar",width="29")
btIN.grid(row=1,column=4,columnspan=2) 

btPQ = tk.Button(framePesquisar,text="Pesquisar",command=pesquisar,width="25")
btPQ.grid(row=4,column=2,columnspan=1)
